...
#### This data is taken from the [Two Sigma Kaggle](https://www.kaggle.com/c/two-sigma-financial-modeling) competition and comprises only is marginal subset of the original set.
